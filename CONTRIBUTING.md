...
All 718 tests (2 skipped; count with the optional real datasets provisioned — 656 on a bare synthetic-only checkout) use synthetic signals (and the bundled BEDMAP1 / Otis data) — no
