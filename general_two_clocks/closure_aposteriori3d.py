...
def main():
    ...
    ap.add_argument("--seed", type=int, default=0,
                    help="base seed: DNS uses seed, LES uses seed+1 (default 0 = committed run)")
    ...
    ref = dns_reference_3d(dns_n, kc, nu, args.k_f, args.f_band, args.f_amp, args.dt,
                           spinup, args.n_snap, dns_snap_every, seed=args.seed, xp=xp,
    ...
    for clos in clos_list:
        ...
        les = CoarseLES3D(n_les, kc, clos, nu, args.k_f, args.f_band, args.f_amp,
                          args.dt, seed=args.seed + 1, c_ev=args.c_ev, bs_frac=args.bs_frac, xp=xp)
